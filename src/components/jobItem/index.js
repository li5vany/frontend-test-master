...
const JobItem = ({job, setDetailIdView}) => {

  return (
    <div className="job-item" onClick={() => {setDetailIdView(job.id)}}>
      ...
      <div className="company-description">
        ...
        <div className="secondary-color detail">about {moment(new Date(job.created_at)).fromNow()} <span className="dot"/> {job.location}</div>
